...
const contenido = [
  ...
  },
  {
    ...
    contenido: [
      {
        text:
          "Here we are going to store only the data that is significant to the core of the application (The habits) so there is no need of too many entity relationships. A NoSQL document database works perfectly here since we do not need complex transactions. ",
        image: Mongo,
  ...
  },
  {
    ...
    contenido: [
      ...
      {
        text:
          "A DAO (data access object) is a software design pattern, whose objective is to provide the implementation needed to connect to a data base service and perform queries to it.",
        image: DAO,
    ...
    <div className="container-fluid">
      <div className="container">
        ...
        <h2 className="alignTextCenter">
          For this section, since Loop habit tracker has very limited
          functionalities that rely on internet connection, we have prepared our
          own cloud solution proposal for this app.
        </h2>
        ...
        <div className="row">
          <div className="col col-12 col-md-6 colorBorderRight">
            <p className="alignTextCenter">
              Even though currently Loop Habit tracker works perfectly with out
              or with internet, the app could improve easily, integrating what
              they already have with a cloud data base, with out affecting their
              current functionalities and accessing to global data analysis of
              the user’s habits and cloud support to their clients (which the
              lack of it seems to be a recurring pain point on the app’s
              reviews).
            </p>
          </div>
          <div className="col col-12 col-md-6 my-auto">
            <RatingCard title="Eventual connectivity score" score={4.5}></RatingCard>
          </div>
        </div>
        <hr />
      </div>
