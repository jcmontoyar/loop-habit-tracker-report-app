...
const contenido = [
  ...
  },
  {
    ...
    contenido: [
      {
        text: "	In this point the app could see some improvement since it is overusing the class Integer instead using primitive int. We found over 34 classes that use Integer object for handling attributes that could be easily replaced with int.   The same goes for Long which includes over 40 classes where the object Long is used instead of primitive long.",
        image: Picture1,
  ...
  },
  {
    ...
    contenido: [
      {
        text: "Even though they use primarily indexed loops, they are overusing the for each method in some classes. In some other few cases they are using iterator of keys and values that could also be replaced with indexed loops in order to improve performance.",
        image: For,
  ...
  },
  {
    ...
    contenido: [
      {
        text: "As we explained on the caching section of the report, Habit tracker uses for the most part Linked Lists. Since this is a non-memory efficient data structure, we would recommend replacing all Linked lists with ArrayMaps. This data structure would improve the memory usage without compromising the response speed time that Linked lists provide currently to the app.",
        image: Hash,
  ...
  },
  {
    ...
    contenido: [
      {
        text: "This android method is only used 13 times (on 7 different activities) in the whole android Habit tracker project, for that reason it would not be recommended to make code changes to move to a binding pattern (it would not be worth it since it has very low usage).",
        image: Lupa,
  ...
  },
  {
    ...
    contenido: [
      {
        text: "We found 7 different layouts with nested linear layouts, you can check the list at the right image. In order to make the application more optimal Habit tracker would need to replace those layouts using constrained or relative ones.",
        image: Layout,
        alt: "Image of an Android layout",
        h: "400px",
        w: "210px",
        titulo: "Using relative or constraint layouts instead of nested linear layouts",
      }
    ],
  },
  {
    ...
    contenido: [
      ...
      },
      {
        ...
        image: Dark1,
        alt: "Image of about and setting activities using dark theme with GPU overdraw utility enabled",
        h: "500px",
        w: "610px",
        titulo: "Dark Theme"
      },
      {
        ...
        image: Dark2,
        alt: "Image of Habits list and habit detail activities using dark theme with GPU overdraw utility enabled",
        h: "500px",
        w: "610px",
  ...
  },
  {
    ...
    contenido: [
      {
        text: "As shown in the Linter analysis, there are 70 unused resources in the whole application. These are 70 small fix changes that could be easily done, and while doing so you would be improving the performance, as well as the memory usage of the application.",
        image: Picture1,
